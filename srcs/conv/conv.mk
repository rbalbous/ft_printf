...
#    Updated: 2018/01/17 17:25:29 by rbalbous         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CONVK =		pf_k.c
KPATH = srcs/conv/k
CONVK_PATH = $(addprefix srcs/conv/k/, $(CONVK))
OBJ += $(addprefix $(OBJ_PATH)/, $(CONVK:.c=.o))

CONVM =		pf_m.c
MPATH = srcs/conv/m
CONVM_PATH = $(addprefix srcs/conv/k/, $(CONVM))
OBJ += $(addprefix $(OBJ_PATH)/, $(CONVM:.c=.o))

CONVW =		pf_w.c \
			pf_cap_w.c
WPATH = srcs/conv/w
CONVW_PATH = $(addprefix srcs/conv/w/, $(CONVW))
